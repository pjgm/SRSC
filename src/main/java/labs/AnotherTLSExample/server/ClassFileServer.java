package labs.AnotherTLSExample.server;
...
public class ClassFileServer extends ClassServer {
   ...
   // We also can pass a port as an argument - see below
     ...
     *
     * @param docroot : path where the server reads the files
...
//              keystore - chaves do servidor: criada com passwd indicada
		...
		ks.load(new FileInputStream("labs/TLSCODE/serverkeystore"), passphrase);//
