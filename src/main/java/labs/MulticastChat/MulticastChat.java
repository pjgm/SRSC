/*
package labs.MulticastChat;// labs.MulticastChat.java
// Objecto que representa um chat Multicast

import java.io.*;
import java.net.*;

public class labs.MulticastChat extends Thread {
  ...
  public labs.MulticastChat(String username, InetAddress group, int port,
                       int ttl, 
