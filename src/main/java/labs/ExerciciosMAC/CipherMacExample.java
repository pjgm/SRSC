 ...
 * Usa-se neste caso cifra AES e modo CTR
 */
...
{   
        ...
        throws Exception
    {
        ...
        String          input = "Transferencia EUR:0000100 to AC 1234-5678";
        ...
        System.out.println("plain : " + Utils.toString(plainText, messageLength) + " verificacao: " + MessageDigest.isEqual(mac.doFinal(), messageHash));
    }
}
