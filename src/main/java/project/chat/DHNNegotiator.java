...
public class DHNNegotiator<U extends Comparable> {
    ...
    public DHNNegotiator(U me, List<U> users, DHNSend sender, DHNReceive receiver){
        this(me, users, sender, receiver, g512, p512, dhSize);
    }
    public DHNNegotiator(U me, List<U> users, DHNSend sender, DHNReceive receiver, BigInteger g, BigInteger p, int size){
        this.me = me;
        userList = users;
    ...
    public byte[] negotiate(boolean waitForMainUser) throws Exception {
        DHParameterSpec dhParams = new DHParameterSpec(p, g, size);
